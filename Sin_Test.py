...
n = 2000  # Number of Datapoints for Training And Test
shape = [n, 1]
...
for i in range(len(models)):
    ...
    plt.plot(sorted_x_test, sorted_results)
    ...
    if save_to_file:
        tikzplotlib.save("Plots/"+name+"_sin.tex", axis_width=r"\textwidth")
        plt.clf()
    else:
        plt.show()
    ...
    if save_to_file:
        tikzplotlib.save("Plots/" + name + "_Loss_sin.tex", axis_width=r"\textwidth")
        plt.clf()
    else:
        plt.show()
